<?php 
	...
	$sucesso = $dao->cadastrarPessoa($pessoa);

	if ($sucesso){
		$mensagem = "<strong>$pessoa->nome cadastrado com sucesso!</strong>";
	}else{
...
<body>
  ...
  <div class="container">
    ...
    <a href="inserirPessoa.php"><button class="btn btn-info m-3" type="submit">Voltar</button></a>
  </div>
